...
func createMovie(w http.ResponseWriter, r *http.Request) {
	...
	// Assign IDs and append all movies
	for i := range newMovies {
		newMovies[i].ID = strconv.Itoa(rand.Intn(10000000))
		movies = append(movies, newMovies[i])
	}
	json.NewEncoder(w).Encode(newMovies)
}
